...
\label{Chapter3} % For referencing the chapter elsewhere, use \ref{Chapterr3}
...
So I spent the first two weeks surfing on the internet to gather every information I found about \vc. I wrote a report containing general information and and every project interesting for the rest of my internship.
...
\section{\emph{rpi-playground} Project}

This project \parencite{wiki:xxx} \parencite{WinNT}

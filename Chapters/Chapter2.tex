...
The second \keyword{key thing} is that they share the same \keyword{RAM} memory as figure~\ref{sharedRAM} taken from the \bcm{} documentation\parencite{refBCM} shows:

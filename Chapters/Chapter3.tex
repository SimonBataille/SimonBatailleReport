...
-- To integrate the \api{} I add the \file{qpu-asm} and \file{asm} directories to the existing \file{optical\_flow\_internship} project. I also add \file{grad.c} and \file{grad.c} to \file{src} directory. Finally I modified \file{opt\_flow\_lk.cpp}, \file{opt\_flow\_video.cpp} and \file{main.cpp} to be able to run \flow{} \code{program} on \vc.
...
\begin{itemize}
	...
	\item send \code{code-to-execute} \keyword{pointers} and variables called \uni{}s to the \qpu{}s

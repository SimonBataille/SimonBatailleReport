...
For the \iBubble{} tracking system - NotiloTracker - optical flow is the displacement of points of interest - called \keyword{features} - between two consecutive frames from a video.
...
\begin{figure}[!htbp]
	...
	\caption{Optical flow for the initial set of features}
...
There are several algorithms to compute \emph{optical flow}. Camille selected the \keyword{Lucas-Kanade} method to be implemented on \vc.
%----------------------------------------------------------------------------------------

...
\begin{alertblock}{Projets indépendants}
\begin{itemize}
\item Aucune API officielle
\item Projets indépendants sur github -- helloworld et pi-gemm github
...
\begin{itemize}
\item GPU piloté par un CPU: interface mailbox
\item Mémoire RAM partagée entre CPU \& GPU: 2 espaces d'adresses
\end{itemize}
\end{alertblock}

\begin{block}{Etapes de programmation}
\begin{enumerate}
...
\begin{alertblock}{Architecture d'un projet}
\begin{itemize}
\item GPU piloté par un CPU: interface mailbox
\item Mémoire RAM partagée entre CPU \& GPU: 2 espaces d'adresses
\end{itemize}
...
\begin{block}{Mémoire partagée \& fonctionnalité du GPU}
\begin{itemize}
\item Initialiser la mémoire partagée
\item Copier données et les variables
\item Transmettre les pointeurs
...
\begin{figure}
\centering
\includegraphics[scale=0.3]{images/archOverview.pdf}
\end{figure}
...
\begin{frame}{Architecture d'un projet}
